...
#
# Generated by Vivado on Fri Aug 18 11:22:56 +0800 2017
...
# Script info
echo -e "div_gen_1.sh - Script generated by export_simulation (Vivado v2017.1 (64-bit)-id)\n"
...
simulate()
{
  $xv_path/bin/xsim div_gen_1 -key {Behavioral:sim_1:Functional:div_gen_1} -tclbatch cmd.tcl -log simulate.log
}
